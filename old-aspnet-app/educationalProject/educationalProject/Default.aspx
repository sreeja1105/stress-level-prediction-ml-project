  ...
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        <img src="img/slider/ed5.jpg" alt="" title="#slider-direction-1" />
        <img src="img/slider/ed1.jpg" alt="" title="#slider-direction-2" />
        <img src="img/slider/ed6.jpg" alt="" title="#slider-direction-3" />
      </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              ...
              <p>
              Stress is regarded as a major thing that is used to create an imbalance in the life of every character and it is additionally regarded as a major issue for psychological adjustments and trauma reduction.
              </p>
              <p>The main objective of this application is to identify stress in college students and take precautionary measures to overcome and helps students to improve their performance.
              </p>
              <!--<p>
              ...
              <ul>
                ...
                <li>
                  <i class="fa fa-check"></i> KNN Algorithm
                </li>
        ...
        <div class="team-top">
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="img/team/bhargavi.jpeg" alt="">
									</a>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="img/team/sreeja.jpeg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="img/team/bhavya.jpeg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
...
<a href="https://newhorizonindia.edu/nhengineering/">NHCE </a>  
