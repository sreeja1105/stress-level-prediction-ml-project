        ...
        <!-- single-well end-->
              ...
              <a href="#">
               ...
               <div class="field your-name form-group">
                    OLD PASSWORD:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtOldPassword" runat="server" TextMode="Password" Height="30px" Width="400px"></asp:TextBox>
               ...
               <div class="field your-name form-group">
                    NEW PASSWORD:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtNewPassword" runat="server" TextMode="Password" Height="30px" Width="400px"></asp:TextBox>
               ...
               <div class="field your-name form-group">
                     CONFIRM PASSWORD: <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" Height="25px" 
            ...
            <asp:Button ID="btnUpdate" runat="server" Text="Change Password" 
                    class="btn btn-theme pull-left" ValidationGroup="a" 
