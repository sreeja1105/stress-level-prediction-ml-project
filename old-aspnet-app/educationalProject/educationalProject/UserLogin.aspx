...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="container">
      ...
      <div class="row">
        ...
        USERNAME: <asp:TextBox ID="txtUserId" runat="server" Width="400px" Height="30px"></asp:TextBox>
           ...
           PASSWORD: <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="400px" 
